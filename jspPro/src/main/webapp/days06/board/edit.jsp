...
<h3>
  <span class="material-symbols-outlined">view_list</span> jsp days04 - edit.jsp
</h3>
<div>
  <xmp class="code">
  ...
  <!-- action 속성이 없으면 본인페이지에 있던 파라미터 그대로 가지고 재요청이 일어난다 -->
  <form method="post">
  	<table>
  		 <tr>
         ...
         <tr>
            ...
            <td><input type="text" name="writer" size="15" disabled="disabled" value="${ dto.writer }"></td>
         </tr>
         <tr>
